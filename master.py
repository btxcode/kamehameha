...
def loading_animation():
    log("run", "Initializing Kamehameha Scanner...")
    time.sleep(1)
...
"""
    ...
    # Mencetak Nama Scanner
    print(f"{Fore.YELLOW}{Style.BRIGHT}          K A M E H A M E H A   S C A N N E R{Style.RESET_ALL}\n")
    
    # Mencetak info versi (menggunakan variabel global TOOL_NAME dan VERSION jika sudah diubah di atas)
    print(f"{Fore.GREEN}=== {TOOL_NAME} {VERSION} ==={Style.RESET_ALL}")
    print("Ready to blast vulnerabilities away!\n")
...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            log("info", "Thank you for using Kamehameha Scanner. See you later!")
            sys.exit(0)
        else:
